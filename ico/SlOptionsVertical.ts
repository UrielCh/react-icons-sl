...
/**
 * OptionsVertical icon from Simple Line Icons
 * @module
 */
export function SlOptionsVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SlOptionsVertical;
