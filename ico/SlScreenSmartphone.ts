...
/**
 * ScreenSmartphone icon from Simple Line Icons
 * @module
 */
export function SlScreenSmartphone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SlScreenSmartphone;
