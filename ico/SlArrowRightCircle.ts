...
/**
 * ArrowRightCircle icon from Simple Line Icons
 * @module
 */
export function SlArrowRightCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SlArrowRightCircle;
