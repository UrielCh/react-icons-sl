...
/**
 * MagnifierRemove icon from Simple Line Icons
 * @module
 */
export function SlMagnifierRemove(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SlMagnifierRemove;
